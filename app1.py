...
@app.route("/")
@app.route("/api/bots")
@app.route("/api/bot/<string:any_username>")
def all_routes(any_username=None):
    # Ignore JSON, always render full website
...
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=8080)        "color": "#ff0000"
    },
    {
        "username": "@TPCGUILDVIPBOT",
        "name": "TPC Guild FF Bot",
